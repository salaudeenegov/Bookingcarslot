  ...
  const NavLinks = ({ mobile = false }) => {
    ...
    return (
      <>
        {role === "user" && (
          <>
            <NavLink to="/home/user" className={linkClasses}>
              Home
            </NavLink>
            <NavLink to="/home/user/book" className={linkClasses}>
              Book Slot
            </NavLink>
            <NavLink to="/home/user/history" className={linkClasses}>
              My History
            </NavLink>
            <NavLink to="/home/user/profile" className={linkClasses}>
              Profile
            </NavLink>
          </>
        )}
        ...
        {role === "admin" && (
          <>
            <NavLink to="/home/admin" className={linkClasses}>
              Dashboard
            </NavLink>
            {/* <NavLink to="/home/admin/slots" className={linkClasses}>
              Slots
            </NavLink> */}
            <NavLink to="/home/admin/employee" className={linkClasses}>
              User Management
            </NavLink>
            <NavLink to="/home/admin/logs" className={linkClasses}>
              Logs
            </NavLink>
          </>
        )}
      ...
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <Link
              to="/"
              className="text-2xl font-bold text-amber-600 tracking-tight"
            >
              ParkingWalla
            </Link>
          </div>
        ...
        <div className="md:hidden bg-white border-t border-slate-200">
          ...
          <div className="pt-4 pb-3 border-t border-amber-200">
            ...
            <div className="mt-3 px-2 space-y-1">
              <Link
                to="/profile"
                className="block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-amber-100"
              >
                Your Profile
              </Link>
              <Link
